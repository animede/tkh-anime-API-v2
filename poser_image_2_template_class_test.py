...
def main():
    ...
    parser.add_argument("--up_url",   type=str,  default="http://127.0.0.1:8008/resr_upscal/", help="サービスを提供するポートを指定。")
    parser.add_argument('--filename','-i', default='00004.png', type=str)
