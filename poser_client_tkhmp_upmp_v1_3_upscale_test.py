...
def main():
    ...
    parser.add_argument('--host', default='http://127.0.0.1:8001', type=str)
    parser.add_argument('--esr', default='http://127.0.0.1:8008', type=str)
    parser.add_argument('--mode', default='fullbody', type=str)
    ...
    #mode="face", "breastup" , "waistup" , "upperbody" ,"fullbody", "full"
    pose_moce=args.mode
    fps=args.fps
    scale=args.scale
